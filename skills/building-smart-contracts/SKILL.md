...
3. **Generate code:**
   ...
   - Follow syntax rules from `algorand-typescript-rules` skill

4. **Include tests:**
   - Always include or suggest integration tests
   - Use generated clients for testing contracts
   - See `testing-smart-contracts` skill for patterns
...
- [Syntax Rules](../algorand-typescript-rules/SKILL.md)
- [Testing Patterns](../testing-smart-contracts/SKILL.md)
- [AlgoKit Commands](../algokit-commands/SKILL.md)
